...
unsigned int InCollection_Pok[C_QuestionRAM];//ï¿½Üµï¿½ï¿½ï¿½×¥Pok
unsigned int Pokecatch_Pok[C_QuestionRAM];//Ã¿Ò»ï¿½ï¿½×¥ï¿½ï¿½ï¿½ï¿½Pok
...
//typedef  struct
//{
//	unsigned int Mission_Cur ;//=0;//Êµï¿½Ê±ï¿½Å´ï¿½1ï¿½ï¿½Ê¼
...
//const unsigned int Play_Cnt_Max[]={0,0,5,3,2,2};//Ç°ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ð§ï¿½ï¿½ï¿½ï¿½Ó¦2ï¿½ï¿½ï¿½Ë¿ï¿½Ê¼
...
unsigned Select_Question_OtherMode_Quality(unsigned Mode,unsigned int diff_int,unsigned Max_quality)//,Ð¡ï¿½Úµï¿½ï¿½ï¿½ Max_quality unsigned int R_quality,
{
...
unsigned Select_Question_ModeStatus_Other(unsigned Mode,unsigned int R_quality,unsigned Max_quality)//,Ð¡ï¿½Úµï¿½ï¿½ï¿½ i_quality
{
...
//	    Mem0.Mission_Cur++;
//
//		if(Mem0.Mission_Cur==Mission_Num)//Ñ¡ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½Ã´ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½??
//			{
//
//			   Mem0.Mission_Cur =0;
//
...
/////////////////////////////////////////////////////////////////////////   end_start
   ...
   temp = GetWalk(gQuestionIdx);//temp ï¿½ï¿½ï¿½Ü¸ï¿½
...
//////////////////////////////////////////////////////////////////////////////////////speed
    ...
    if(Mem0.Mode== Classic_M)
     ...
     if(Mem0.Mission_Cur>0)//ï¿½ï¿½Ö´ï¿½ï¿½ ENVI_MOV()
     {
	 ...
	 while(1)
		 {
           ...
           if(FiveSec_cnt>=Time_Countdownflag)
           {
			 ...
			 if(WaitAction(24,55)==1)//12  55ï¿½ï¿½Ð§ 2-ï¿½ò²¥·Å±ï¿½ï¿½ï¿½ï¿½ï¿½
				 {
				  FiveSec_cnt=0;	
...
//		 else
	 ...
	 if((Eventflag == N_Event12)||(Eventflag == N_Event14))
		 ...
		 Light_all_off();
          ...
          Key_Event|=Key_E_Temp;//Key_True|Key_False;//playï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
	  ...
	  while(i<C_Player_Num)//C_Player_Num <16
	  	{
			...
			//cnt_temp = temp;
			if(Lowest_Player==temp2)  //ï¿½ï¿½ß·ï¿½
				{
...
// 2nd highest      
     ...
     temp2= Registered_Play_Status&(~Lowest_Player);//ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
     temp = Get_Num_Higgest_score(temp2);  


	   if(temp2 !=Leader_Player)//ï¿½ï¿½ï¿½ï¿½ï¿½Ö»ï¿½Ð¶ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
	   	{
            ...
            sec_highest_cnt = temp;
	   	   ...
	   	   if(temp2!=Leader_Player)////ï¿½ï¿½ï¿½ï¿½ï¿½Ö»ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
	   	   	{
  ...
  if(Final_ScorefalgOREndround==1)
  	{
       ...
       if(highest_cnt>1)
		 ...
		 // Leader_Player = t_highest_Player;  //ï¿½ï¿½Leaderï¿½ï¿½ï¿½ï¿½Ä±ï¿½
		  Lowest_Player = t_lowest_Player;
...
//			   	  Player_Selectcnt[Player_Activing_Cnt]++;
	   ...
	   {
//	   	  if(Player_Activing_Bit ==0) //Ö»ï¿½ï¿½Ò»ï¿½ï¿½playerÊ±,Player_Activing_Bitï¿½ï¿½ï¿½ï¿½
//		      return Go_Rest();
//		  else
                ...
                if((Cheater_SeletQu_Flag ==0)||(Player_Activing_Bit==0))
                	{
					   ...
					   if(temp ==0)
                           ...
                           temp = Registered_Play_Status&(~(Player_Activing_Bit|Key_buffer_First));	//Temp_Registered_Play_Statusï¿½Ð¿ï¿½ï¿½Ü»ï¿½ï¿½ï¿½Öµ
					   	}
...
//	unsigned int qestion_dif_dis =0;
    ...
    if(Cheater_SeletQu_Flag)
     ...
     if(gQuestionIdx!=C_Finish) 
	       return;
	  //else //Ã»ï¿½ï¿½ï¿½ï¿½Ñ¡ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ñ¡ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
	    //  return Go_Rest();
	    
      //  Cheater_SeletQu_Flag =0;//ï¿½ï¿½ï¿½ï¿½ï¿½Ñ¡ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Òªï¿½ï¿½ï¿½ï¿½
   	}
...
////////////////////////////////////////////////////////////////// 
	     ...
	     if(gQuestionIdx!=0xffff)  
          ...
          gQuestionIdx = Select_Question_OtherMode_Quality(Question_mode,Diff_int,qestion_quality);//0xffff ï¿½ï¿½ï¿½ï¿½mode
                   ...
                   if(QuestionCycle[3] == Normal_Cycle)
                   	{
						...
						while(1)
						 ...
						 if(Sleepflag)
						  ...
						  if(temp==1)//Eventï¿½É¹ï¿½ 
				   	         return C_SelectQuestion_Round3;
						  else if(temp == 2) //ï¿½ï¿½Event
						 	return Select_Question_NormalRaund2or3(Round3);
						 // else if(temp == 0)
						 //	{
...
//	unsigned temp = 0;
	...
	unsigned int i_Pre =0;//ï¿½ï¿½Ò»ï¿½ï¿½
...
void  ButtonisPressed()
{
                      ...
                      if(((BitMap[Mem0.Mission_Cur%16]&Mission_Success[Mem0.Mission_Cur/16])||(Mem0.MissionZ_flag==0))&&(((Mem0.firstFlag_23b&0x80)==0)))  // Mem0.Mission_Cur<1
						 {
						 	    if((Mem0.firstFlag_23b&0x0200)==0)//ï¿½ï¿½Ö¹ï¿½Ù´Î½ï¿½ï¿½ï¿½
						 	    {
  ...
  //Key_Buffer =0;
	...
	{	
		...
		if(Key_Buffer)//(Key)||
		{
          ...
          // if(Key_Event)//ï¿½ï¿½Ç°ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
          // { 
          //  temp =Key;//ï¿½ï¿½Ç°ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
          //  Key_Event =0;
          // }
           ...
           if(temp==(Key_True|Key_False))
                  ...
                  //Key_TrueFlase_Buffer = (Key_True|Key_False);//temp;
		       ...
		       else
		       	{
		       	    if(temp ==0)//Ì§ï¿½ï¿½
						  ...
						  temp = Key_Buffer&(Key_True);//Key_Falseï¿½ï¿½Ð§;//Key_Buffer&Key_TrueFlase_Buffer;//Key;//ï¿½ï¿½ï¿½Â¸ï¿½Öµ
		       	    	}
		       	     else
		       	     	{
		       	          temp =0;
          ...
          else 
        	{
                  ...
                  //	{
                   ...
                   //   Key_TrueFlase_Buffer =0;  
					//  temp = Key_Buffer&Key_TrueFlase_Buffer;//Key;//ï¿½ï¿½ï¿½Â¸ï¿½Öµ
...
//		 LED_Down = Led1;//LED_Back;
   ...
   {
                    G_X_A  = G_Back;//G_Hit;////Öµï¿½ï¿½ï¿½Ó·ï¿½ï¿½ï¿½
                    G_X_M  = G_Hit;//G_Back;////Öµï¿½ï¿½ï¿½Ù·ï¿½ï¿½ï¿½
        ...
        while(1)
     	{
			...
			if(WaitAction(10*16,0)&C_MovSucessStatus)// Ö»¼ì²âshake ÓÃC_MovSucess
			   {
		...
		if(c_mvm==G_SixDir)   
		  ...
		  {	
		  			  ...
		  			  if(c_mvm == G_TurnAround)
						{
                            ...
                            Light_all_off();//ÉÏÒ»²½ÓÐLed_On(All_Led_data);/
...
//       Dis_Player =0;
	    ...
	    BlinkFlag_Data = Get_LedDate_From_Play(Key_activeflag);
		 ...
		 FiveSec_cnt =0;
		 PlayQuestionflag =0x01;//ï¿½ï¿½Í£   Ë«ï¿½ï¿½  ï¿½Ø¸ï¿½
		
		do				//   ï¿½ï¿½ï¿½Å·ï¿½ï¿½ï¿½  pause =2
		 {
		    ...
		    PlayQuestionflag =0;//Ë«ï¿½ï¿½ ï¿½ï¿½Í£ ï¿½ï¿½ï¿½Ø¸ï¿½
			FiveSec_En =0;
...
//	        Blink_temp = All_Led_data;  
	   ...
	   // PlayA1800_Elements(SFX_Tictac);
		...
		if((Round ==1)||(Soloflag))
           PlayQuestionflag =0x01;//Ë«ï¿½ï¿½ï¿½Ø¸ï¿½  ï¿½ï¿½Í£ ï¿½Ø¸ï¿½
		else
		  PlayQuestionflag =2;//Ë«ï¿½ï¿½ ï¿½ï¿½Í£ ï¿½ï¿½ï¿½Ø¸ï¿½
		
		do				//Ö»ï¿½Ð²ï¿½ï¿½Å·ï¿½ï¿½ï¿½ï¿½Å»ï¿½pause
		 {
...
///////////////////////////////////////////////////////////////////  end difficulty solo
 ...
 if(Question_Answer == Right)
    ...
    else
    {
     ...
     // if(Key_buffer_First&ALL_Play_Registed_Init) //solo ï¿½ï¿½ Paralyzedï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
     // 	{
			...
			if(WaitAction(60*16,0)==C_MovSucess)//Mov_Detected
			  {
	             ...
	             Led_OFF_Some(Led1_white|Led2_white|Led3_white|Led4_white);//µÍÍÆ
...
//  	  {
//  	  	
//  	  	   if((Index==14)||(Index==16)||(Index==21)||(Index==30))//_02ï¿½Úµï¿½ï¿½ï¿½ï¿½ï¿½
//  	  	   {
//  	  	   	
//  	  	   	   if(i==2)
