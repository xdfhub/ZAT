...
/* void GetMode()
{
	 ...
	 switch(Io_temp)
	 {
	 	case 0x180:   Switch_Mode = Key_Game;   gTemp = C_StartGame ;break;//VOL1Flag =1; break;//7+ Start_MAGIC_QUESTIONS_Step2
	 	case 0x280:   Switch_Mode = Key_Instruction;  gTemp = C_Off_Mode ; VOL1Flag =0;break;//C_Demo_Mode
	 	case 0x380:   Switch_Mode = Key_TryMe; gTemp = C_Off_Mode; VOL1Flag =0;break;	
	 	case 0x300:   Switch_Mode = Key_Game_Family;   gTemp = C_Demo_Mode ; VOL1Flag =0;break;//VOL2  14+ //C_StartGame
	 	default:
